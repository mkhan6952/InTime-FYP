...
<div class="mb-3 text-center mt-5" style="font-size: 30px;">
    <i class="fa fa-plus-square" style="font-size:48px;color:#00aa63;padding-top:10px;"></i>
    <span>InTime-(Travel Insurance)</span>
  </div>
  <p class="text-center" style="font-size: 20px;"> <i style="color:#00aa63;" class="fas fa-user-secret "></i> <span>Users
      Login</span>
  </p>
      ...
      <div class="col-sm-6 col-md-4">
        <form action="" class="shadow-lg p-4" method="POST">
          <div class="form-group">
            <i style="color:#00aa63;"  class="fas fa-user"></i><label for="email" class="pl-2 font-weight-bold">Email</label><input type="email"
              class="form-control" placeholder="Email" name="rEmail">
          </div>
          <div class="form-group">
            <i style="color:#00aa63;"  class="fas fa-key"></i><label for="pass" class="pl-2 font-weight-bold">Password</label><input type="password"
