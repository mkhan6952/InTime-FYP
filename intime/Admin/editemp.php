...
session_start();
 ...
 if(isset($_REQUEST['empupdate'])){
  ...
  $sql = "UPDATE employee_tb SET empName = '$eName', empCity = '$eCity', empMobile = '$eMobile', empEmail = '$eEmail' WHERE empid = '$eId'";
...
<div class="col-sm-6 mt-5  mx-3 jumbotron">
  <h3 class="text-center">Update Doctors Details</h3>
  <?php
 if(isset($_REQUEST['view'])){
  $sql = "SELECT * FROM employee_tb WHERE empid = {$_REQUEST['id']}";
