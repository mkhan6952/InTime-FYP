...
if(isset($_SESSION['is_adminlogin'])){
 ...
 if(isset($_REQUEST['assign'])){
  ...
  if(($_REQUEST['request_id'] == "") || ($_REQUEST['request_info'] == "") || ($_REQUEST['requestdesc'] == "") || ($_REQUEST['requestername'] == "") || ($_REQUEST['address1'] == "") || ($_REQUEST['address2'] == "") || ($_REQUEST['requestercity'] == "") || ($_REQUEST['requesterstate'] == "") || ($_REQUEST['requesterzip'] == "") || ($_REQUEST['requesteremail'] == "") || ($_REQUEST['requestermobile'] == "") || ($_REQUEST['doc_name'] == "") || ($_REQUEST['inputdate'] == "")){
   ...
   $msg = '<div class="alert alert-warning col-sm-6 ml-5 mt-2" role="alert"> Fill All Fileds </div>';
    ...
    $docemail =$_REQUEST['doc_email'];
    $docnumber =$_REQUEST['doc_number'];
    $rdate = $_REQUEST['inputdate'];
    $sql = "INSERT INTO assignwork_tb (request_id, request_info, request_desc, requester_name, requester_add1, requester_add2, requester_city, requester_state, requester_zip, requester_email, requester_mobile, doc_name,doc_email , doc_number, assign_date) VALUES ('$rid', '$rinfo','$rdesc', '$rname', '$radd1', '$radd2', '$rcity', '$rstate', '$rzip', '$remail', '$rmobile', '$doc_name','$docemail' , '$docnumber', '$rdate')";
...
<div class="col-sm-5 mt-5 jumbotron">
  ...
  <form action="" method="POST">
    <h5 class="text-center">Assign Doctors To Claim Request</h5>
    ...
    <div class="form-group">
      <label for="request_info">Injury Type</label>
    ...
    <div class="form-row">
      <div class="form-group col-md-6">
        <label for="assigntech">Assign Doctor</label>
    ...
    <div class="form-row">
      <div class="form-group col-md-6">
        ...
        <input type="text" class="form-control" id="doc_email" name="doc_email" >
      </div>
      <div class="form-group col-md-6">
        <label for="doc_number">Doctor Number</label>
